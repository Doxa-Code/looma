...
export const productAgent = new Agent({
  ...
  instructions: `
      ...
      - Responda estritamente ao que for solicitado pelo atendente, exceto ao sugerir produtos relacionados e em promoção, e somente quando solicitado.
      ...
      - Sugestões de produtos sempre pertinentes, em estoque, em promoção e apenas quando solicitado.
